...
int main( )
{
    ...
    window = glfwCreateWindow( 1024, 768, "LASER CHESS", nullptr, nullptr);
    if( window == nullptr ){
    ...
    } while( glfwGetKey(window, GLFW_KEY_ESCAPE ) != GLFW_PRESS && glfwWindowShouldClose(window) == 0 ); /// Check if
    /// the ESC key was pressed or the window was closed
